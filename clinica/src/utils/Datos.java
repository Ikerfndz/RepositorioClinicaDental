...
public class Datos {
	...
	public static final Revision REVISIONES[] = {
			...
			new Revision("Alteraciones de la estructura (mancha blanca, hipoplasia del esmalte y erosi贸n).",
					CITAS[000002]),
			new Revision("Alteraciones en el n煤mero (supernumerarios, anodoncias).", CITAS[000003]),
			new Revision("Lesiones cariosas con exposici贸n pulpar y amplia destrucci贸n coronaria.", CITAS[000004]),
			new Revision("Dolor a la percusi贸n (vertical)", CITAS[000005]),
			new Revision("Alteraciones en el color (pigmentaci贸n intr铆nseca).", CITAS[000006]),
