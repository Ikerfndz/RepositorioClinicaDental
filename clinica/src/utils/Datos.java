...
public class Datos {
    ...
    public static final Paciente PACIENTES[] = {
        new Cliente("Luis", 1, "Gijon",  "942779900","luis@educantabria.es", 33,5675543D),
        new Cliente("Maria", 2, "Gijon",  "984557700","marta11@educastur.es", 20,3875643F),
        new Cliente("Juan", 3, "Malaga",  "985123745","illojuan1@educastur.es", 25,5345643F),
        new Cliente("Fermin", 4, "Lugones",  "984559137","fermin22@educastur.es", 19,6375643F),
        new Cliente("Catalina", 5, "Palencia",  "984108744","catali@educastur.es", 22,7875643n)
    };
    public static final int numClientes = PACIENTES.length;
