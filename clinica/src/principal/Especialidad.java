...
public class Especialidad {
	private long idEsp; //Identificador de la especialidad que se va rellenando automáticamente cada vez que se hace una llamada a sus constructores
	private String nombreEsp; // Nombre de la especialidad de tipo String
	private static int numeroEspecialiades = 0; // Variable que utilizaremos para completar de forma automática el identificador de la especialidad.
	private Cirujano cirujano; // Variable de tipo Cirujano donde guardaremos a que cirujano pertenece la especialidad.

	
	//Constructor por defecto, cada vez que le hagamos una llamada aumentará el numero de especialidades en 1 y se le asignará ese valor al identificador.
	public Especialidad() {
	...
	//Se le pide al usuario que escriba el nombre de la especialidad y se guarda en una variable auxiliar.
	//Esta variable será la que pasaremos por parametros haciendo llamada al constructor anterior para establecer el nombre de la especialidad
