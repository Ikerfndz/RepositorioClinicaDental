...
public class Especialidad {
	private long idEsp;
	// Identificador de la especialidad que se va rellenando autom�ticamente cada
	...
	// numero de especialidades en 1 y se le asignar� ese valor al identificador.
	public Especialidad() {
	...
	// M�todo encargado de guardar la nueva especialidad de un cirujano.
